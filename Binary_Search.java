...
System.out.println("Time complexity Iterator: "+(end-start)+"ns");
return;
}
else
high=mid-1;
...
System.out.println("Time complexity for recersive: "+(end-start)+"ns");
return;
}
if(a[mid]>k)
...
System.out.println("Time complexity recursive: "+(end-start)+"ns");
}
}
